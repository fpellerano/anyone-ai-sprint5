...
```bash
# $ sudo docker run --rm --net host --gpus all -it \
...
$ docker run --rm --net host -it \
    -v "mnt/c/Users/u189197/Desktop/TAMBO/AnyoneAI/Sprint5/sprint_05_project/sprint5-project":/home/app/src \
    --workdir /home/app/src \
    s05_project \
    bash

jupyter
docker run --rm --net -p 8888:8888 -it \
    -v $(pwd):/home/app/src \
    --workdir /home/app/src \
    s05_project \
    bash
